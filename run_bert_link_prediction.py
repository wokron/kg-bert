...
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer, embeddings: StackedEmbeddings, print_info = True):
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        # assert len(input_embeddings) == max_seq_length
...
def main():
    ...
    if args.do_predict and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
            ...
            for test_triple in test_triples:
                ...
                tmp_features = convert_examples_to_features(tmp_examples, label_list, args.max_seq_length, tokenizer, embeddings, print_info = False)

                eval_dataloader = create_dataloader(tmp_features, args.eval_batch_size, SequentialSampler)
                ...
                eval_dataloader = create_dataloader(tmp_features, args.eval_batch_size, sampler_class=SequentialSampler)
